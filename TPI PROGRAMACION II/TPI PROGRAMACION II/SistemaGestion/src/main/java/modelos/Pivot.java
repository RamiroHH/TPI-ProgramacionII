...
public class Pivot extends Jugador {
    ...
    public Pivot(int id, String nombreCompleto, int edad, double altura, double peso, String rolDestacado, String posicion, int tamañoFuerza, int rebote, int bloqueo, int defensa) {
    ...
    public String toString() {
        return "Pivot{" + super.toString() + ", tamanoFuerza=" + tamañoFuerza + ", rebote=" + rebote + ", bloqueo=" + bloqueo + ", defensa=" + defensa + '}';
    }
}
